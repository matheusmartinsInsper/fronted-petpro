            ...
            <Box width={"22%"} borderRadius="md" boxShadow="md" height="100%" zIndex={9} bg="#F6F7F9" px="2" mr="2">
              ...
              <Box mt="4">
                ...
                {selectedButton === 'Prioridade' && (
                  <>
                    <Tooltip
                      label="Somente agendamentos não cancelados"
                      fontSize="sm"
                      bg="gray.700"
                      color="white"
                      borderRadius="md"
                ...
                {selectedButton === 'Status' && (
                  <>
                    ...
                    <Box mb={2}>
                      ...
                      <Progress bgColor="#F6F7F9" size="sm" value={agendamentosPotStatus.Andamento} sx={{ "& > div": { backgroundColor: "primary.900" } }} borderRadius="md" />
                    </Box>
                    <Box mb={2}>
