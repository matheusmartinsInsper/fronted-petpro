...
<Flex justify="flex-end" mt={4} pr={4}>
  ...
  <Flex mt={4}>
    ...
    <Box width="70%" border="1px" borderColor="gray.200" borderRadius="md" p={2} overflowY={"auto"}  maxHeight="350px" >
        <Text fontSize={"sm"} fontWeight={"bold"} mb="2" bgColor={"primary.500"} borderTopRadius={"md"} p={"2"} borderBottomWidth={"2px"} borderBottomColor={"primary.300"}>Serviços</Text>
      {service != undefined ?(
        <Box>
            ...
            <Button mt={4} bgColor={"white"} size={"sm"} color={"primary.200"} boxShadow={"md"} _hover={{ backgroundColor: "primary.300", color: "primary.100" }} onClick={unselectservice}>Cancelar</Button>
        </Box>
