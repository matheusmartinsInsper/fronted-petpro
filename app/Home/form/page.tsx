...
const Forms = () => {
  ...
  const [selectedForm, setSelectedForm] = useState<Form | null>(null); // Estado para armazenar o formulário selecionado
            ...
            <Table variant="simple">
              <Thead backgroundColor={"primary.200"} color={"primary.100"}>
                <Tr>
                  ...
                  <Th color={"primary.100"}>Quantidade de Campos</Th> {/* Nova coluna */}
              ...
              <Tbody>
                {paginatedForms.map((form, index) => (
                  <Tr key={index} paddingY={"2.5"}>
                    <Td>{form.nameform}</Td>
                    <Td>{form.idform}</Td>
                    <Td>{form.fieldCount}</Td> {/* Exibindo a contagem de campos */}
                    <Td paddingY={"2.5"}>
                        <Flex>
                        <Link >
                        <IconButton
