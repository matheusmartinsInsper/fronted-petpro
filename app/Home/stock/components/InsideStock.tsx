...
const IsideStock = ({ isOpen, onClose, stock }: StockModalProps) => {
    ...
    const handleMoveStock = async () => {
        try {
            ...
            toast({
                title: "Entrada bem-sucedida",
                description: "Entrada de dados realizada com sucesso.",
                status: "success",
                duration: 5000,
                isClosable: true,
            });
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <ModalOverlay />
            <ModalContent>
                <ModalHeader color={"primary.100"} bgColor={"primary.300"} borderTopRadius={"md"}>Dar Entrada</ModalHeader>
                <ModalCloseButton />
